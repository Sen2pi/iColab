...
import {
  useCreateTarefa,
  useGetGrupoById,
  useGetRecentInscricoes,
  useGetRecentRequesitos,
...
const TarefaForm = ({ action }: TarefaFormProps) => {
  ...
  const { data: inscricoes, isPending: isInscricaoLoading } =
    useGetRecentInscricoes();
  const { data: requesitos, isPending: isRequesitoLoading } =
    useGetRecentRequesitos();
              ...
              <FormControl>
                ...
                >
                  {isInscricaoLoading && !inscricoes ? (
                    ...
                    inscricoes?.documents.map(
                      (inscricao) =>
                        groupId === inscricao.grupo.$id &&
                        !inscricao?.inscrito?.docente && (
                          <FormItem
